...
import com.sampurna.pocketmoney.databinding.TemplatePaymentHistoryType2Binding
    ...
    inner class CustomerTransactionHistoryViewHolder(
        ...
        init {
            ...
            itemView.setOnClickListener {
                mListener.onTransactionHistoryItemClick(itemList[absoluteAdapterPosition])
            }
        }
