...
import com.sampurna.pocketmoney.mlm.adapters.AccountSettingChildAdapter
import com.sampurna.pocketmoney.mlm.adapters.AccountSettingParentAdapter
import com.sampurna.pocketmoney.mlm.adapters.DashboardItemAdapter
import com.sampurna.pocketmoney.mlm.model.ModelMenuItem
import com.sampurna.pocketmoney.mlm.model.ModelParentMenu
...
*/
    ...
    override fun onMenuClick(menu: ModelMenuItem) {
        when (menu.id) {
            ...
            NavigationEnum.MY_COUPON->{
                startActivity(Intent(requireActivity(), ManageCoupon::class.java))
            }
            NavigationEnum.PROFILE-> {
