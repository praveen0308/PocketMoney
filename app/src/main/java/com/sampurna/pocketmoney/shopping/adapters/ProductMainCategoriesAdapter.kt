...
import com.sampurna.pocketmoney.databinding.TemplateCategoryListItemCardViewBinding
import com.sampurna.pocketmoney.databinding.TemplateCategoryListItemHrBinding
    ...
    inner class ProductMainCategoriesViewHolder(val binding:TemplateCategoryListItemHrBinding,private val mListener:ProductMainCategoriesInterface):RecyclerView.ViewHolder(binding.root){
        ...
        init {
            itemView.setOnClickListener {
                mListener.onMainCategoryClick(categoryList[absoluteAdapterPosition])
            }
        }
