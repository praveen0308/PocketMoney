package com.sampurna.pocketmoney.utils.myEnums
...
enum class NavigationEnum{
    ...
    DIRECT_COMMISSION, SHOPPING_COMMISSION, UPDATE_COMMISSION, SERVICE_COMMISSION, HELP_CENTRE, ABOUT, SHARE, CHANGE_PASSWORD
