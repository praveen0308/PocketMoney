...
import com.example.pocketmoney.databinding.TemplateProductViewForHrBinding
        ...
        init {
            itemView.setOnClickListener {
                productClickListener.onProductClick(
                    productModels[absoluteAdapterPosition].ProductId,
                    productModels[absoluteAdapterPosition].ItemId
                )
            }
        }
    }
