...
import com.jmm.core.databinding.TemplateMobileOperatorSimplePlanBinding
import com.jmm.model.serviceModels.MobileOperatorPlan
import com.jmm.model.serviceModels.SpecialPlan
...
class OperatorPlanAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when(viewType){
            1->SimplePlanViewHolder(
                TemplateMobileOperatorSimplePlanBinding.
    ...
    inner class SimplePlanViewHolder(val binding:TemplateMobileOperatorSimplePlanBinding,private val mListener: OperatorPlanAdapterListener):RecyclerView.ViewHolder(binding.root){
        ...
        init {
            binding.btnAmount.setOnClickListener {
                mListener.onPlanClick(planList[adapterPosition])
            }
        }
