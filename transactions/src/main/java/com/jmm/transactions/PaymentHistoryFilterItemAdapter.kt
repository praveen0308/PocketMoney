...
import com.jmm.core.databinding.TemplateMultiSelectionDialogItemBinding
import com.jmm.core.databinding.TemplateSingleSelectionDialogItemBinding
    ...
    inner class MultiSelectionViewHolder(val binding: TemplateMultiSelectionDialogItemBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
            binding.checkBox.setOnCheckedChangeListener { _, isChecked ->
                ...
                paymentHistoryDialogListener.onSingleItemClick(itemList[adapterPosition].categoryId,itemList)
            }
        }
