...
import com.jmm.payout.databinding.TemplateBeneficiaryListItemBinding
    ...
    inner class BeneficiaryListViewHolder(
        ...
        init {
            itemView.setOnClickListener {
                mListener.onBeneficiaryClick(mList[adapterPosition])
            }
            binding.btnTransfer.setOnClickListener {
                mListener.onTransferClick(mList[adapterPosition])
            }
