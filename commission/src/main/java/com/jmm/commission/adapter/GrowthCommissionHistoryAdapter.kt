...
import com.jmm.core.databinding.TemplateCustomerCommissionBinding
    ...
    inner class GrowthCommissionHistoryViewHolder(
        ...
        init {
            ...
            itemView.setOnClickListener {
                mListener.onCommissionHistoryItemClick(itemList[adapterPosition] as CommissionHistoryModel)
            }
        }
