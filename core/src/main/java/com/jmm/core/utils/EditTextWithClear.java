...
public class EditTextWithClear
    ...
    private void init() {
        ...
        mClearButtonImage = ResourcesCompat.getDrawable(getResources(),
                        R.drawable.ic_baseline_highlight_opaque_24, null);
        mSearchButtonImage = ResourcesCompat.getDrawable(getResources(),
                R.drawable.ic_search, null);
        mSearchButtonImage.setTint(getResources().getColor(R.color.colorBlack));
        setBackground(ContextCompat.getDrawable(getContext(),R.drawable.bg_edit_text_rect_5dp_light_grey));
                        ...
                        if (event.getAction() == MotionEvent.ACTION_DOWN) {
                            ...
                            mClearButtonImage =
                                    ResourcesCompat.getDrawable(getResources(),
                                            R.drawable.ic_baseline_highlight_24, null);
                            showClearButton();
                        }
                        // Check for ACTION_UP.
    ...
    private void showClearButton() {
        ...
        setCompoundDrawablesRelativeWithIntrinsicBounds
                (mSearchButtonImage,                      // Start of text.
                        null,               // Top of text.
