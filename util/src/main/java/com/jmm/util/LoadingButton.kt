...
import com.jmm.util.databinding.LayoutLoadingButtonBinding
    ...
    fun setState(state: LoadingStates, mText:String="", msg:String=""){
        when(state){
            ...
            LoadingStates.FAILED ->{
                binding.apply {
                    btnAction.setBackgroundColor(ContextCompat.getColor(context,R.color.red_800))
                    btnAction.setCompoundDrawables(ContextCompat.getDrawable(context,R.drawable.ic_baseline_error_24),null,null,null)
                    btnAction.text = mText
                    progressStatus.isVisible = false
            ...
            LoadingStates.SUCCESS ->{
                binding.apply {
                    btnAction.setBackgroundColor(ContextCompat.getColor(context,R.color.green_800))
            ...
            LoadingStates.RETRY ->{
                binding.apply {
                    btnAction.isEnabled= true
                btnAction.setBackgroundColor(ContextCompat.getColor(context,R.color.orange_800))
