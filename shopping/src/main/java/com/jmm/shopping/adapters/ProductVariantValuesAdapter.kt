...
import com.jmm.core.databinding.TemplateVariantColorViewBinding
import com.jmm.core.databinding.TemplateVariantTextViewBinding
            ...
            itemView.setOnClickListener {
                for (i in 0 until productVariantValueList.size) {
                    if (i == adapterPosition) {
                        productVariantValueList[adapterPosition].isSelected = true
                        mListener.onItemClick(productVariantValueList[adapterPosition])
                    } else {
        ...
        fun createVariantColor(variantValue: ProductVariantValue) {
            ...
            if (variantValue.isSelected == true) {
                binding.cdSelectionIndicator.setCardBackgroundColor(
                        ContextCompat.getColor(itemView.context,
                                IdentifyColor(productVariantValueList[adapterPosition].Varients_Value_Code))
                )
            } else {
                binding.cdSelectionIndicator.setCardBackgroundColor(
                        ContextCompat.getColor(itemView.context,
