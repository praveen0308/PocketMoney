...
class ShoppingComponentMasterAdapter(
    var productModels: List<ProductModel>?,
    var productClickListener: ProductClickListener
) : RecyclerView.Adapter<ShoppingComponentMasterAdapter.ShoppingHomeCategoriesViewHolder>() {
    ...
    inner class ShoppingHomeCategoriesViewHolder(
        ...
        override fun onClick(v: View) {
            productClickListener.onProductClick(productModels!![absoluteAdapterPosition].ProductId,productModels!![absoluteAdapterPosition].ItemId)
        }
